...
export const moves = {
  ...
  "방전":         { power: 40, type: "전기", accuracy: 100, alwaysHit: false, effect: { chance: 0.3, status: "마비" } },
  ...
  "성장":       { power: 0,  type: "풀", accuracy: 100, alwaysHit: true, targetSelf: true, effect: null,
                  rank: { atk: 1, turns: 1 } },
  "흡수":       { power: 30, type: "풀", accuracy: 100, alwaysHit: false, effect: { drain: 0.12 } },
  "메가드레인": { power: 30, type: "풀", accuracy: 100, alwaysHit: false, effect: { drain: 0.12 } },
  "기가드레인": { power: 45, type: "풀", accuracy: 100, alwaysHit: false, effect: { drain: 0.12 } },
  ...
  "생명의물방울":{ power: 0,  type: "물",   accuracy: 100, alwaysHit: true,  effect: { heal: 0.1 },  targetSelf: true },
