...
export const moves = {
  ...
  "성장":     { power: 0, type: "노말", accuracy: 100, alwaysHit: true, effect: null,
                rank: { atk: 1, turns: 2 } },
  "야금야금": { power: 40, type: "노말", accuracy: 100, alwaysHit: false, skipEvasion: true, ignoreDefRank: true, effect: null },
...
"싫은소리":   { power: 0, type: "노말", accuracy: 85, alwaysHit: false, effect: null,
  ...
  "열풍":         { power: 50, type: "불", accuracy: 90, alwaysHit: false, effect: { chance: 0.1, status: "화상" } },
  ...
  "탁류": { power: 50,  type: "물", accuracy: 85, alwaysHit: false, targetSelf: false, effect: null,
                  rank: { chance: 0.3, targetSpd: -1, turns: 3 } },
...
rank: { def: 1, turns: 2 }},
  ...
  "맹독":     { power: 0, type: "독", accuracy: 90, alwaysHit: false, effect: { status: "독" } },
  ...
  "뛰어오르기":   { power: 50, type: "비행", accuracy: 85, alwaysHit: false, effect: {chance: 0.3, status: "마비"}, fly: true },
  ...
  "사념의박치기":   { power: 50, type: "에스퍼", accuracy: 90, alwaysHit: false,
 ...
 "용성군":   { power: 60, type: "드래곤", accuracy: 90, alwaysHit: false, effect: null,
  ...
  "세차게휘두르기": { power: 40, type: "악", accuracy: 100, alwaysHit: false,  effect: null },
